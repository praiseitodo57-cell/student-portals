 ...
 const router = useRouter();
  ...
  return (
      <main className="bg-gradient-to-t flex min-h-screen bg-gray-100 w-full items-center justify-center md:p-2 ">
        <section className="w-full max-w-full sm:max-screen-sm md:max-w-screen-md lg:max-screen-lg mx-auto rounded-md shadow-2xl overflow-hidden p-4 md:p-6 lg:p-8">
